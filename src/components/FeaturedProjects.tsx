...
const projects = [
  {
    ...
    description: 'This is a placeholder description for the first featured project. Replace with your real project details.',
    image: 'https://via.placeholder.com/600x300/94a3b8/ffffff?text=Project+1',
  ...
  },
  {
    ...
    description: 'This is a placeholder description for the second featured project. Replace with your real project details.',
    image: 'https://via.placeholder.com/600x300/94a3b8/ffffff?text=Project+2',
    tags: ['Placeholder', 'Demo'],
    github: '#',
    external: '#',
  },
  {
    ...
    description: 'This is a placeholder description for the third featured project. Replace with your real project details.',
    image: 'https://via.placeholder.com/600x300/94a3b8/ffffff?text=Project+3',
    tags: ['Placeholder', 'Demo'],
    github: '#',
    external: '#',
  },
  {
    ...
    description: 'This is a placeholder description for the fourth featured project. Replace with your real project details.',
    image: 'https://via.placeholder.com/600x300/94a3b8/ffffff?text=Project+4',
    tags: ['Placeholder', 'Demo'],
    github: '#',
    external: '#',
  }
